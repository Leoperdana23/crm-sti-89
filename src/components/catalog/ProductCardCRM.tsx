...
interface ProductCardCRMProps {
  product: Product & { displayPrice?: number; showResellerPrice?: boolean };
  canManage?: boolean;
  onEdit?: () => void;
  onDelete?: () => void;
}
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between pt-2">
            <div>
              ...
              {product.showResellerPrice && product.reseller_price && product.reseller_price !== product.price && (
